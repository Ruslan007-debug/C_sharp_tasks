...
namespace HospitalManagementSystem
{
    public class Hospital
    {
        ...
        public void HospitalizePatient(int patientId, int roomNumber)
        {
            ...
            currentRoom.AddPatient(currentPatient);
        }
        ...
        {
            List<MedicalRecord> allRecords = new();
        ...
        {
            var totalPatientsInRooms = Rooms.Sum(r => r.Patients.Count());
            return $"\n=== СТАТИСТИКА ЛІКАРНІ ===\n" +
